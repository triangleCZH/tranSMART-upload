...
createFolderVCF () {
echo ""
cd /home/transmart/transmart/transmart-batch/studies/$1
...
cd /home/transmart/transmart/transmart-batch/studies/
...
cd /home/transmart/transmart/transmart-batch/studies/$1/vcf
vcfName="`ls`"
